class scene1 extends Phaser.Scene {
    ...
    create () {
        ...
        plataformas.create(200,500,"plataformas").setScale(6,1.5); // hijos de ese grupo 
        plataformas.create(500,800,"plataformas").setScale(6,1.5); // hijos de ese grupo 
        plataformas.create(1600,500,"plataformas").setScale(6,1.5); // hijos de ese grupo 
        plataformas.create(1500,800,"plataformas").setScale(6,1.5); // hijos de ese grupo 
        plataformas.create(1000,700,"plataformas").setScale(6,1.5); // hijos de ese grupo 
        plataformas.create(600,500,"plataformas").setScale(6,1.5); // hijos de ese grupo 
        plataformas.create(1200,900,"plataformas").setScale(6,1.5); // hijos de ese grupo 
        plataformas.create(1000,1000,"plataformas").setScale(80,1.5); // hijos de ese grupo 
